...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class KoinComposeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final KoinComposeViewmodelLibraryAccessors laccForKoinComposeViewmodelLibraryAccessors = new KoinComposeViewmodelLibraryAccessors(owner);
         ...
         * with version reference <b>koin.cmp</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        /**
         * Group of libraries at <b>koin.compose.viewmodel</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public KoinComposeViewmodelLibraryAccessors getViewmodel() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForKoinComposeViewmodelLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class KoinComposeViewmodelLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public KoinComposeViewmodelLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getNavigation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("koin.compose.viewmodel.navigation");
        }
    ...
    public static class KtorClientLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>okhttp</b> with <b>io.ktor:ktor-client-okhtpp</b> coordinates and
         * with version reference <b>ktor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
     ...
     */
    @Deprecated
    public static class KtorSerializationLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>jetbrainsKotlinJvm</b> with value <b>2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KoinVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>koin</b> with value <b>4.1.0-Beta4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koin.cmp</b> with value <b>1.2.0-Beta4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCmp() { return getVersion("koin.cmp"); }
    ...
    public static class KotlinVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Group of versions at <b>versions.kotlin.serialization</b>
         */
    ...
    public static class KotlinSerializationVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>kotlin.serialization</b> with value <b>1.7.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlin.serialization.plugin</b> with value <b>2.1.10</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlugin() { return getVersion("kotlin.serialization.plugin"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>jetbrainsKotlinJvm</b> with plugin id <b>org.jetbrains.kotlin.jvm</b> and
    ...
    public static class JetbrainsKotlinPluginAccessors extends PluginFactory {
         ...
         * with version reference <b>kotlin.serialization.plugin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
